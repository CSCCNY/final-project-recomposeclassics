...
from ethan_autoencoder_2 import SPECTROGRAMS_PATH


HOP_LENGTH = 256
SAVE_DIR_ORIGINAL = "samples/original/"
SAVE_DIR_GENERATED = "samples/generated/"
MIN_MAX_VALUES_PATH = "/Users/ethancobb/Documents/CUNY/Deep Learning/Final Project/Code/Autoencoder/fsdd4/min_max_values.pkl"
...
if __name__ == "__main__":
    ...
    # replace the double slash with a single slash to avoid key error
    min_max_values = {key.replace('//', '/'):val for key, val in min_max_values.items()}
    ...
    # convert spectrogram samples to audio (without going through autoencoder)
